...
if __name__ == '__main__':
    ...
    param1 = {"txtUserName": "chn0622@sina.com", "txtPassword": "chn6432431"}
    param2 = 'txtPassword=chn6432431&txtUserName=chn0622%40sina.com'
    r1 = rc.post(url1, data={"txtUserName": "chn0622@sina.com", "txtPassword": "chn6432431"}, verify=False)
    # r1 = rc.post(url1, json=param1, verify=False)
